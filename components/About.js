...
export default function About() {
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center px-6 py-4 mt-8 text-xl text-center text-white border-4 shadow-lg border-highlight1 bg-highlight1 place-self-center md:text-xl lg:text-2xl shadow-black">
        <FadeUp>
